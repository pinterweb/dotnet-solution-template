namespace BusinessApp.App.UnitTest
{
    ...
    public class BackgroundLogDecoratorerTests
    {
        ...
        {
            [Fact]
            public async Task WithEntry_CallsDecoratedLogger()
            {
                /* Arrange */
            ...
            [Fact]
            public async Task WhenHasMultipleEntry_LoggedInOrder()
            {
                /* Arrange */
            ...
            [Fact]
            public async Task WhenDisposed_NotLogged()
            {
                /* Arrange */
                sut.Dispose();
            ...
            [Fact]
            public async Task WhenDisposed_ConsoleLogged()
            {
                /* Arrange */
                var entry = A.Dummy<LogEntry>();
                sut.Dispose();
            ...
            [Fact]
            public async Task WhenLoggerThrows_ConsoleLogged()
            {
                /* Arrange */
            ...
            [Fact]
            public async Task WhenLoggerThrows_NewLogEntryCreated()
            {
                /* Arrange */
                var data = new { };
            ...
            [Fact]
            public async Task WhenLoggerThrows_NewExceptionCreated()
            {
                /* Arrange */
                var data = new { };
